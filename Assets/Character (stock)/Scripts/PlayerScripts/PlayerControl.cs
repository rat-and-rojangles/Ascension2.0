...
public class PlayerControl : MonoBehaviour
{
	...
	bool IsGrounded() {
		...
		RaycastHit hit;
		//the origin is offset up with the collider. it's hard coded because i won't change it and don't want more variables
		return Physics.SphereCast (transform.position+ Vector3.up*0.87f, 0.5f, Vector3.down, out hit, distToGround /*+ 0.2f*/);
	...
	void Update()
	{
		...
		attack = Input.GetButtonDown ("Attack") && !aim;
