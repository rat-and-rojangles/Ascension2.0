...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void LateUpdate()
	{
		...
		angleH += Mathf.Clamp(Input.GetAxis("CamHorizontal"), -1, 1) * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(Input.GetAxis("CamVertical"), -1, 1) * verticalAimingSpeed * Time.deltaTime;
