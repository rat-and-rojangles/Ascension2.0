...
namespace Footsteps {
	...
	public class SurfaceManager : MonoBehaviour {
		...
		string GetMeshMaterialAtPoint(Vector3 worldPosition) {
			Ray ray = new Ray(worldPosition + Vector3.up * 0.01f, Vector3.down);
			RaycastHit hit;
			...
			if (r == null || r.sharedMaterial == null || r.sharedMaterial.mainTexture == null || r == null || mc == null) {
				return "";
			}
